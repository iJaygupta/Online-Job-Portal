             ...
             <div class="row">
                <div class="col-xs-12 text-center">
                    <span class="section-tit-line"></span>
                        <h2>Job Details</h2>
                        <p><a href="#"><i class="fa fa-home" aria-hidden="true"></i></a> &nbsp; > &nbsp;<a href="#">Click Apply</a> 
                        &nbsp; > &nbsp;To Send Application</p>
                </div>    
            </div>
        </div>
    </div>
...
PreparedStatement stmt=conn.prepareStatement("select * from jobs where jobid='"+str+"'");
...
{ %> 
                            ...
                            <h3 class="margin-bottom-60"><%=rs.getString(1)%> </h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <% String ema=rs.getString(10); %>
                                        <%=rs.getString(10)%>
                                    </div>
                                </div> <form action="ApplyJobServlet" method="post">
                                    <input type="hidden" name="Idem" value="<%=ema%>" >
