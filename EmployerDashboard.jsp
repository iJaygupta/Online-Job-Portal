...
<% String name = (String)request.getAttribute("E"); %>      
    <header>
        <!-- start topbar -->
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 text-right hidden-md hidden-sm hidden-xs">
                        <nav class="jbm-menu-container">
                            <ul class="jbm-menu list-none dis-inline">
                                ...
                                <li>
                                    <a href="Candidatesapplication.jsp?me=<%=name%>">Candidates Application<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                                    </li>
                                <li>
             ...
             <div class="row">
                <div class="col-xs-12 text-center">
                    <span class="section-tit-line"></span>
                        ...
                        <p><a href="#"><i class="fa fa-home" aria-hidden="true"></i></a> &nbsp; > &nbsp;<a href="#">Showing</a> 
                        &nbsp; > &nbsp;Employer Details</p>
                </div>    
            </div>
        </div>
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12 pull-right">
                       <div class="jbm-company-info">
                            ...
                            <div class="company-details margin-bottom-30 change-pass padding-bottom-60">
                                <h3 class="margin-bottom-60">Employer Details</h3>
...
PreparedStatement stmt=conn.prepareStatement("select * from employer where email='"+name+"'");
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12 ">
                        <div class="jbm-emp-sidebar padding-bottom-30 padding-top-30">
                            <ul class="jbm-dashboard-links">
                                <li>
                                    <a href="employer-information.html" class="active">Employer Informations</a>
                                </li>
                                
                                
                                <li>
                                    <a href="Candidatesapplication.jsp?me=<%=name%>">Candidates Application</a>
                                </li>
                                
                               
                                <li>
                                    <a href="PostJobServlet?em=<%=js%>">Post a Job</a>
                                </li>
                                <li>
