...
hod {background: #FFF8DC;color:#E9967A;}

.nav {background:#FFF8DC;}
   ...
   <link rel="stylesheet" type="text/css" href="assets/css/shasha.css">
...
PreparedStatement stmt=conn.prepareStatement("select * from applications where Appid='"+str+"'");
ResultSet rs = stmt.executeQuery();
%>
<% while(rs.next())
{ %> 

                            <h3 class="margin-bottom-60"><%=rs.getString(1)%> </h3>
                                <div class="row">
                                ...
                                <form action="SelectCandidate.jsp" method="post">   
                                <input type="hidden" name="role" value=<%=jay %>>
                                <input type="hidden" size="textarea" name="seekee" value=<%=rs.getString(11)%>>
                                <input type="hidden" name="ee" value=<%=rs.getString(14) %>>
              
                <input type="submit" class="buttom" size="5" name="submit" id="submit" tabindex="5" value="Schedule Interview!">
                </form>
					</div>
