             ...
             <div class="row">
                <div class="col-xs-12 text-center">
                    <span class="section-tit-line"></span>
                        ...
                        <p><a href="#"><i class="fa fa-home" aria-hidden="true"></i></a> &nbsp; > &nbsp;<a href="#">Please Login</a> 
                        &nbsp; > &nbsp;To Hire Geeks</p>
                </div>    
            </div>
        </div>
...
<body>
  ...
  <div class="form">
    ...
    <form name="myform" action="EmployerLoginServlet" method="post">
      <input type="email" name="email" placeholder="example@domain.com" required=""/>
      <input type="password"  name="pass" required="" placeholder="password"/>
      <button>login</button>
      <p class="message">Not registered? <a href="RegisterEmployer.jsp">Create an account</a></p>
    </form>
