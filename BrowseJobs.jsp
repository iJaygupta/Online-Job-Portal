...
<th class="column1">Job Role</th>
<th class="column2">Company</th>
<th class="column3">Qualification</th>
<th class="column4">Salary</th>
<th class="column5">Experience</th>
...
{ %>    
<tr>
<td class="column1"><%=rs.getString(1)%></td>
<td class="column2"><%=rs.getString(2)%></td>
<td class="column3"><%=rs.getString(3)%></td>
<td class="column4"><%=rs.getString(4)%></td>
<td class="column5"><%=rs.getString(5)%></td>
<td class="column6"><%=rs.getString(6)%></td>
<% id[i]=rs.getString(11); %>
<td class="column7"><a href="ViewJob.jsp?userId=<%=id[i]%>"> Apply</a>  </td>
</tr>
