             ...
             <div class="row">
                <div class="col-xs-12 text-center">
                    <span class="section-tit-line"></span>
                        ...
                        <p><a href="#"><i class="fa fa-home" aria-hidden="true"></i></a> &nbsp; > &nbsp;<a href="#">Pages</a> 
                        &nbsp; > &nbsp;404 Error</p>
                </div>    
            </div>
        </div>
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12 pull-right">
                       <div class="jbm-company-info">
                            ...
                            <div class="company-details margin-bottom-30 change-pass padding-bottom-60">
                                <h3 class="margin-bottom-60">JobSeeker Details</h3>
                                
<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>  
<%@ page import="java.sql.*" %>
<%@ page import="java.io.*" %> 

<%String nam = (String)request.getAttribute("J"); %>
<%                   
try {

Class.forName("com.mysql.jdbc.Driver");
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jobmarket", "root", "admin");
PreparedStatement stmt=conn.prepareStatement("select * from jobseeker where email='"+nam+"'");
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12 ">
                        <div class="jbm-emp-sidebar padding-bottom-30 padding-top-30">
                            <ul class="jbm-dashboard-links">
                                <li>
                                    <a href="#" class="active">Candidates Profile</a>
                                </li>
                                
                                
                                <li>
                                    <a href="ApplicationStatus.jsp?me=<%=nam%>">Applications Status</a>
                                </li>
