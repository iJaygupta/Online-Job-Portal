  ...
  <div class="dropdown-content">
             ...
             <div class="row">
                <div class="col-xs-12 text-center">
                    <span class="section-tit-line"></span>
                        ...
                        <p><a href="#"><i class="fa fa-home" aria-hidden="true"></i></a> &nbsp; > &nbsp;<a href="#">Please Sign up</a> 
                        &nbsp; > &nbsp;To Hire Best Talents</p>
                </div>    
            </div>
        </div>
    </div>
    ...
    <div style="background-image: url(assets/img/bg.jpg)" class="w3ls-banne">
		...
		<div class="containe">
                   ...
                   <form action="AddEmployerServlet" method="post">
					<ul class="field-list">
						<li class="name">
							<label class="form-label"> Name <span class="form-required"> * </span></label>
							<div class="form-input">
								
									<input type="text" name="ename" placeholder="First Name and Last Name" required>
							...
							<div class="form-input">
								<input id="email" name="eemail" placeholder="example@domain.com" required="" type="email">
							</div>
						</li>
                         <li> 
							<label class="form-label"> Company <span class="form-required"> * </span>
							</label>
							
							<div class="form-input">
								<input id="username" name="cname" placeholder="company name" required="" tabindex="2" type="text">
							</div>
						</li>
						<li>
							<label class="form-label"> Create a password <span class="form-required"> * </span></label>
							<div class="form-input">
						...
						<li>
						<label class="form-label"  style="color: white" > Company Type <span class="required"> * </span> </label>
						<div class="form-input">
						<select class="select-style gender" name="ctype">
                                 <option value="Service Based Company">Service Based</option>
						...
						<li> 
							...
							<div class="form-input">
								<input id="phone" name="emobile" placeholder="phone number" required="" type="text">
							</div>
						</li>
