...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/jay.css">
...
%>
             ...
             <div class="row">
                <div class="col-xs-12 text-center">
                    <span class="section-tit-line"></span>
                        ...
                        <p><a href="#"><i class="fa fa-home" aria-hidden="true"></i></a> &nbsp; > &nbsp;<a href="#">Please Log in</a> 
                        &nbsp; > &nbsp;To Apply Latest Job Openings</p>
                </div>    
            </div>
        </div>
    </div>
 ...
 <div  class="login-page" > 
  ...
  <div class="form">
    ...
    <form name="myform" action="JobseekerLoginServlet" method="post">
      <input type="email" name="jemail" placeholder="example@domain.com" required=""/>
      <input type="password"  name="jpass" required="" placeholder="password"/>
      <button>login</button>
      <p class="message">Not registered? <a href="RegisterJobseeker.jsp">Create an account</a></p>
    </form>
