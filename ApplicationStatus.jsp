...
<%
try {
String sr=request.getParameter("me");   
Class.forName("com.mysql.jdbc.Driver");
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jobmarket", "root", "admin");
PreparedStatement stmt=conn.prepareStatement("select * from applicationstatus where Email='"+sr+"'");
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column2">Employer Email</th>
									<th class="cell100 column3">Status</th>
									<th class="cell100 column4">Interview Date</th>
									<th class="cell100 column5">Interview Location</th>
...
%>
				 ...
				 <font  size="5" color="gray">    <a href="BrowseJobs.jsp">>>Apply to More Jobs</a>  </font>
